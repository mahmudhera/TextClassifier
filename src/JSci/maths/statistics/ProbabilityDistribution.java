...
public abstract class ProbabilityDistribution extends Object {
	...
	* Check if the range of the argument of the distribution method is between <code>lo</code> and <code>hi</code>.
        ...
        */
        protected final void checkRange(double x, double lo, double hi) throws Exception {
                if(x<lo || x>hi)
                        throw new Exception("The argument of the distribution method should be between "+lo+" and "+hi+".");
        }
        /**
	* Check if the range of the argument of the distribution method is between 0.0 and 1.0.
        * @exception OutOfRangeException If the argument is out of range.
        */
        protected final void checkRange(double x) throws Exception {
        	if(x<0.0 || x>1.0)
        		throw new Exception("The argument of the distribution method should be between 0.0 and 1.0.");
        }
